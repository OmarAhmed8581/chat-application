...
var MessageRouter = /** @class */ (function () {
    function MessageRouter(messageController) {
        this.messageController = messageController;
        this.router = express.Router();
        this.middleware();
        this.routes();
    }
    MessageRouter.prototype.middleware = function () { };
    MessageRouter.prototype.get = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, search, type, sortKey, isId, contacts, _b, _c, _d, error_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _e.trys.push([0, 3, , 4]);
                        _a = req.query, search = _a.search, type = _a.type, sortKey = _a.sortKey, isId = _a.isId;
                        _c = (_b = this.messageController).get;
    ...
    MessageRouter.prototype.getBy = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.messageController.getBy(search)];
                    case 1:
                        contact = _a.sent();
                        contact === null
                            ? res.status(404).send(new errors_1.NotFoundError("No record found", {
    ...
    MessageRouter.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.messageController.create({ payload: req.body })];
                    case 1:
                        result = _a.sent();
                        res.json(result);
                        return [3 /*break*/, 3];
    ...
    MessageRouter.prototype.edit = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        search = req.query.search;
                        return [4 /*yield*/, this.messageController.edit({
                                query: { id: search },
                                payload: req.body,
                            })];
                    case 1:
    ...
    MessageRouter.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        query = req.query;
                        return [4 /*yield*/, this.messageController.delete({ query: query })];
                    case 1:
                        result = _a.sent();
                        res.json(result);
                        return [3 /*break*/, 3];
    ...
    MessageRouter.prototype.routes = function () {
        ...
        this.router.route("/edit").post(middleware_1.sanitizeBody, middleware_1.trimBodyWhiteSpace, middleware_1.authentication, (0, middleware_1.authorization)([enums_1.Role.User, enums_1.Role.Doctor]), (0, async_wrap_1.asyncWrap)(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        this.router.route("/delete").get(middleware_1.sanitizeQuery, middleware_1.trimQueryWhiteSpace, middleware_1.sanitizeBody, middleware_1.trimBodyWhiteSpace, middleware_1.authentication, (0, middleware_1.authorization)([enums_1.Role.User, enums_1.Role.Doctor]), (0, async_wrap_1.asyncWrap)(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = new MessageRouter(message_controller_1.default);
