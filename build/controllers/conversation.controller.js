...
var ConversationController = /** @class */ (function () {
    ...
    ConversationController.prototype.get = function (search, type, isId, sortKey, pageOptions, date) {
        return __awaiter(this, void 0, void 0, function () {
            var query, filter, searchRegExp, searchableFields;
            return __generator(this, function (_a) {
                ...
                if (isId) {
                    query['$or'] = searchableFields.map(function (field) {
                        var _a, _b, _c;
                        return !type ? (_a = {}, _a[field] = mongoose_1.default.Types.ObjectId(search), _a) : type === enums_1.SearchType.Multi ? (_b = {}, _b[field] = searchRegExp, _b) : (_c = {}, _c[field] = search, _c);
                    });
                }
                else {
                    query['$or'] = searchableFields.map(function (field) {
                        var _a, _b, _c;
                        return !type ? (_a = {}, _a[field] = search, _a) : type === enums_1.SearchType.Multi ? (_b = {}, _b[field] = searchRegExp, _b) : (_c = {}, _c[field] = search, _c);
                    });
                }
                return [2 /*return*/, this.returnGetResponse(query, sortKey, pageOptions, date)];
            });
        });
    };
    ...
    ConversationController.prototype._findConversation = function (search) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = { $or: [{ 'conversationId': search }] };
    ...
    ConversationController.prototype.returnGetResponse = function (query, sortKey, pageOptions, date) {
        return __awaiter(this, void 0, void 0, function () {
            var sort, index, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        if (date == 'Day') {
                            query = {
                                $and: [{
                                        createdAt: {
                                            $gte: new Date((0, moment_1.default)().subtract(1, 'day').toISOString()),
                                            $lte: new Date()
                                        }
                                    }, query]
                            };
